pipeline {
    ...
    environment {
        ...
        CONTAINER_NAME = "jide-flask"
        DOCKER_IMAGE = "jidendir/flask"
        DOCKER_CREDENTIALS_ID = "jide-docker-cred"
        DOCKER_REGISTRY = "https://index.docker.io/v1"
        DOCKER_NETWORK = "app-network"
        ALERT_EMAIL = "joel.jade.9@gmail.com"
    }
